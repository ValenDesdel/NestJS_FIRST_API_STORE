...
export class ProductsService {
    ...
    findAll(): Product[] {//ME RETORNA TODOS LOS PRODUCTOS
    ...
    create(payload: CreateProductDto){//METODO PARA CREAR PRODUCTO - ASI ENVIARÁ LO QUE NOSOTROS ESPERAMOS SEGÚN EL DTOS
    ...
    update(id: number, payload: UpdateProductDto){//AYUDA A NO COMETER ERRORES DE TIPADO
